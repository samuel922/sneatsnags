...
async function main() {
  ...
  const events = [
    ...
    },
    {
      ...
      category: 'Musical',
      subcategory: 'Broadway',
      imageUrl: 'https://images.unsplash.com/photo-1489537235181-fc05c9c4c8e5?w=800&h=600&fit=crop',
      minPrice: 79.00,
      maxPrice: 299.00,
      totalSeats: 1621,
      availableSeats: 350,
    },
    {
      ...
      category: 'Football',
      subcategory: 'NFL',
      imageUrl: 'https://images.unsplash.com/photo-1544387903-6184fb28f0b1?w=800&h=600&fit=crop',
      minPrice: 85.00,
      maxPrice: 500.00,
      totalSeats: 80000,
