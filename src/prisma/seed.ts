  ...
  const events = [
    {
      ...
      description: 'The most anticipated concert tour of the year featuring all eras of Taylor Swift\'s music.',
    ...
    },
    {
      ...
      description: 'Classic AL East rivalry game. Yankees take on the Red Sox in this heated matchup.',
      ...
      category: 'Baseball',
      subcategory: 'MLB',
      imageUrl: 'https://example.com/yankees-redsox.jpg',
      minPrice: 25.00,
      maxPrice: 300.00,
      totalSeats: 52325,
      availableSeats: 8500,
    ...
    },
    {
      ...
      description: 'An evening of stand-up comedy with the legendary Dave Chappelle.',
      ...
      imageUrl: 'https://example.com/dave-chappelle.jpg',
      minPrice: 75.00,
      maxPrice: 250.00,
      totalSeats: 20789,
      availableSeats: 5000,
    },
    {
      ...
      category: 'Basketball',
      subcategory: 'NBA',
      imageUrl: 'https://example.com/lakers-warriors.jpg',
      minPrice: 40.00,
      maxPrice: 400.00,
      totalSeats: 20000,
      availableSeats: 3500,
    },
    {
      ...
      description: 'Billie Eilish brings her latest album to life in this intimate arena tour.',
    ...
    {
      name: 'The Lion King',
      description: 'Disney\'s award-winning musical adaptation of the beloved animated film.',
    ...
    },
    {
      ...
      description: 'NFC East rivalry game featuring America\'s Team vs the defending champions.',
      venue: 'AT&T Stadium',
      address: '1 AT&T Way',
      city: 'Arlington',
      state: 'TX',
      ...
      category: 'Football',
      subcategory: 'NFL',
      imageUrl: 'https://example.com/cowboys-eagles.jpg',
      minPrice: 85.00,
      maxPrice: 500.00,
      totalSeats: 80000,
    ...
    },
    {
      ...
      description: 'Kevin Hart\'s latest comedy tour bringing laughs to audiences nationwide.',
      venue: 'United Center',
      ...
      imageUrl: 'https://example.com/kevin-hart.jpg',
      minPrice: 55.00,
      maxPrice: 200.00,
      totalSeats: 23500,
      availableSeats: 6800,
    },
    {
      ...
      description: 'Coldplay\'s spectacular world tour featuring their latest album and greatest hits.',
      venue: 'SoFi Stadium',
...
function getSectionPriceLevel(sectionName: string): number {
  const premiumSections = ['VIP', 'Premium', 'Club', 'Box', 'Field Level', 'Pit', 'Orchestra', 'Front Row'];
  const midTierSections = ['Lower', 'Floor', 'Mezzanine', 'Baseline', 'Behind Home'];
